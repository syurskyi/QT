...
class ClientAsteroidsGame:
    def __init__(self, seed, player_inputs=[], screen_width=1000, screen_height=600, title="Asteroids"):
        ...
        asteroid_factory = AsteroidFactory(screen=self.screen, seed=seed)
